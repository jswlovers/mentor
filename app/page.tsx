...
export default function Home() {
  ...
  return (
    <div>
      ...
      : <><div className="flex items-center justify-between p-4"><h1 className="font-semibold">{cat==='지역모임'?region+' 지역모임':cat}</h1><Link href="/ask" className="text-sm text-rose-600">글 작성</Link></div><ul className="divide-y">
        {list.map((q) => (
          <li key={q.id}>
